                                        ...
                                        <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active fw-semibold"
                                                    ...
                                                    All
                                                    <span
                                                        class="badge bg-primary-subtle text-primary align-middle rounded-pill ms-1"></span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link fw-semibold"
                                                    ...
                                                    Published
                                                    <span
                                                        class="badge bg-success-subtle text-success align-middle rounded-pill ms-1"></span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link fw-semibold"
                                                    ...
                                                    Scheduled
                                                    <span
                                                        class="badge bg-info-subtle text-info align-middle rounded-pill ms-1"></span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
