                                ...
                                <div class="card-header border-bottom-dashed p-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 mt-sm-0 mt-3">
                                            <h6>
                                                <span class="text-muted fw-normal">Legal Registration No:</span><span
                                                    id="legal-register-no">987654</span>
                                            </h6>
                                            <h6>
                                                <span class="text-muted fw-normal">Email:</span><span
                                                    id="email">velzon@themesbrand.com</span>
                                            </h6>
                                            <h6>
                                                <span class="text-muted fw-normal">Website:</span>
                                                <a href="https://themesbrand.com/" class="link-primary" target="_blank"
                            ...
                            <div class="col-lg-12">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <p class="text-muted mb-1">
                                            Card Holder:
                                            <span class="fw-medium" id="card-holder-name">David Nichols</span>
                                        </p>
                                        <p class="text-muted mb-1">
                                            Card Number:
                                        ...
                                        <p class="text-muted">
                                            Total Amount: <span class="fw-medium" id="">$ </span><span
