                            ...
                            <div class="col-lg-9">
                                <div class="category-select">
                                    ...
                                    @if (isset($childCategories) && $childCategories->isNotEmpty())
                                        <select id="child-category-filter" class="single-select">
                                            <option value="">All Subcategories</option>
                                            @foreach ($childCategories as $childCategory)
                                                <option value="{{ $childCategory->slug }}">{{ $childCategory->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    @endif
                ...
                @push('js')
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const categoryFilter = document.getElementById('child-category-filter');
