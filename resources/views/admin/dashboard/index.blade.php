...
<script src="{{ asset('admin-assets/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
<script src="{{ asset('admin-assets/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>
<script src="{{ asset('admin-assets/assets/libs/swiper/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('admin-assets/assets/js/pages/dashboard-ecommerce.init.js') }}"></script>
@endpush
@section('content')
