        ...
        <div class="container">
            <div class="axil-dashboard-warp">
                <div class="axil-dashboard-author">
                    <div class="media">
                        <div class="thumbnail">
                            <img src="{{ asset('assets/images/product/author1.png') }}"
                        ...
                        <aside class="axil-dashboard-aside">
                            <nav class="axil-dashboard-nav">
                                <div class="nav nav-tabs" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" href="{{ route('profile.edit') }}" role="tab"><i
                                            class="fas fa-user"></i>Account Details</a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group mb--40">
                                                        ...
                                                        <p class="b3 mt--10">This will be how your name will be displayed
                                                            in the account section and in reviews</p>
                                                    </div>
                                                </div>
